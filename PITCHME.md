...
「Lispは木構造なので、Rootから再帰的に評価していけばNodeまでたどり着いて結果を返せそう」

---

## ゆるふわなクラス図

1[](./imgs/golang_lisp.png)

---

## 反省

* 初期実装を勢いで書いたため「純LISP」の仕様を後から確認した
  * 「え、これカッコがいっぱいあるだけでLispじゃなくね？」
